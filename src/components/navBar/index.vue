<template>
  <view>
    <view
      ...
      :class="{ shadow: shadow }"
      :style="'background:' + backGround + ';height:' + (statusBarHeight + menuHeight) + 'px'"
    >
        ...
        <view class="left" @click="clickLeft(isShare)">
          <template v-if="_leftIcon">
            ...
            <view class="arrow-left">
              <view class="iconfont-vant" :class="'icon-vant-' + _leftIcon"></view>
            </view>
          </template>
    ...
    <view
      v-if="clearFloat"
      class="clearfix"
      :style="'height:' + (statusBarHeight + menuHeight) + 'px'"
    ></view>
  </view>
</template>
...
export default {
  ...
  beforeMount() {
    ...
    this.backGround = this.background || this.navColor;
    this.statusBarHeight = this.systemInfo.statusBarHeight;
    this.menuHeight = this.systemInfo.menuHeight;
