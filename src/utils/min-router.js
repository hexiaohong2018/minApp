import { isObject, isFunction, isString, isUndefined, isFalse, isArray } from './common'
...
class MinRouter {
  ...
  _next (args) {
    return new Promise((resolve) => {
      if (isFunction(this._beforeEach)) {
...
MinRouter.install = function (Vue) {
  Vue.mixin({
    beforeCreate: function () {
      if (!isUndefined(this.$options.minRouter)) {
